...
class _AudioAppState extends State<MusicPage> {
  Duration duration;
  Duration position;
  ...
  Future play() async {
    final result = await audioPlayer.play(
        "https://m10.music.126.net/20181215144836/3b6b14fc4412459d4b327f8c37fab181/ymusic/5259/5508/555a/e37d48e015bbffd887ddb0894147d2c2.mp3");
    if (result == 1)
      setState(() {
